...
export function debouncedFixer (target: ExtendedHTMLImageElement|ExtendedHTMLVideoElement, fixer: ((target: ExtendedHTMLImageElement) => void) | ((target: ExtendedHTMLVideoElement) => void)): void {
