...
> Simple CLI for running the test262 suite

<!-- SHADOW_SECTION_DESCRIPTION_SHORT_END -->

<!-- SHADOW_SECTION_BADGES_START -->

<a href="https://npmcharts.com/compare/%40polyfiller%2Ftest262?minimal=true"><img alt="Downloads per month" src="https://img.shields.io/npm/dm/%40polyfiller%2Ftest262.svg"    /></a>
<a href="https://www.npmjs.com/package/%40polyfiller%2Ftest262"><img alt="NPM version" src="https://badge.fury.io/js/%40polyfiller%2Ftest262.svg"    /></a>
...
```
$ npm install @polyfiller/test262
```

### Yarn

```
$ yarn add @polyfiller/test262
```

### pnpm

```
$ pnpm add @polyfiller/test262
```

### Run once with npx

```
$ npx -p @polyfiller/test262 test262
```
